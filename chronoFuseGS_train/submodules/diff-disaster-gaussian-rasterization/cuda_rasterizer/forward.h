...
void preprocess(int P, int D, int M, const float* orig_points,
                ...
                const float* shs, const float* opacityActivations,
                const float* colorActivations, bool* clamped,
                ...
                float tan_fovy, const int t, const int numT, int* radii,
                float2* points_xy_image, float* depths, float* cov3Ds,
                float* colors, float4* conic_opacity, const dim3 grid,
